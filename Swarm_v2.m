...
% Create the swarm chart
figure;
swarmchart(xGGdec, yGGdec, 'red');
hold on
swarmchart(xGLdec, yGLdec, 'green');
hold on 
...
% Create the swarm chart
figure;
swarmchart(xGGres, yGGres, 'red');
hold on
swarmchart(xGLres, yGLres, 'green');
hold on 
...
% Create the swarm chart
figure;
swarmchart(xGGout, yGGout, 'red');
hold on
swarmchart(xGLout, yGLout, 'green');
hold on 
title('Outcome Epoch')